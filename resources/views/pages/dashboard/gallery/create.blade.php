            ...
            <form action="{{ route('dashboard.product.gallery.store', $product->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                ...
                <div class="flex flex-wrap mx-3 mb-6">
                    <div class="w-full px-3">
                        ...
                        <input type="file" multiple name="files[]" accept="image/*" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" placeholder="Photos" id="">
                    </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                    <div class="w-full px-3">
